// save-x-article.js
// 用法: node save-x-article.js <article_url> <ws_url> <work_dir>
...
const [,, ARTICLE_URL, WS_URL, WORK_DIR] = process.argv;
if (!ARTICLE_URL || !WS_URL || !WORK_DIR) {
  console.error('用法: node save-x-article.js <article_url> <ws_url> <work_dir>');
  process.exit(1);
}
...
const OUT_DIR = path.join(WORK_DIR, STATUS_ID);
