...
const [,, ARTICLE_URL, WS_URL, CUSTOM_OUT_DIR] = process.argv;
...
const OUT_DIR = CUSTOM_OUT_DIR || `/tmp/${STATUS_ID}`;
...
async function main() {
  ...
  console.log(`Images:      ${Object.keys(fileMap).length} files`);
  console.log(`Screenshots: ${shotIdx} files`);
