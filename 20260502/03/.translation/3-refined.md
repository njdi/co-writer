...
所有人都想让 AI 给自己出一个百倍机会，谁不想？他们跑去问 AI，AI 给出的全是废话。

别浪费时间了，来做这个。

该去猎寻痛点了。

真实的痛。反复出现的痛。让人付出代价的痛。那种人们已经在抱怨、在搜索、在绕路解决，甚至掏钱买了一堆半吊子工具来应付的痛。
...
Reddit 的价值在于：人们会在上面写长篇大论，带着情绪抱怨。他们会解释问题是什么、自己怎么绕路应付、用过哪些失败的工具、遇到了什么奇葩边缘情况，以及为什么他们被搞得这么烦。

X 的价值在于：人们在公开场合吐槽、寻求推荐、比较工具，还会实时说出市场上正在发生的变化。

别搞一个粗糙的爬虫就说这叫"AI 调研"。

- 能用官方 API 的，就用官方 API。
- API 太乱的场景，用经过授权的监控工具。
- 用提醒机制，不要爬取。
- 只存你需要的数据。
- 遵守规则。
...
Reddit 是了解人们"没被采访时怎么说话"的最好场所之一。
...
不要用野路子爬虫，用官方 API 和经授权的工具。违反平台规则的爬虫，别碰。这不是好主意。
...
命名为：**Recruiter Pain Mining**

或者你正在研究的其他市场名。

目标是收集公开的提及——那些人们在抱怨某个工作流程的地方。
...
LinkedIn、Facebook 和私人社区标记为"谨慎使用"。它们不是没用，但从权限和信号质量来说，麻烦更多。
...
如果一开始觉得逐字段解析太麻烦，可以这样处理：在 Airtable 里建一个长文本字段，命名为 **AI Analysis**，把 AI 的完整输出都塞进去就行。
...
用 Carrd、Framer、Lovable、Bolt、v0 或 Webflow。
...
用 LinkedIn、X、Reddit、你的人脉，或者垂直社区。
